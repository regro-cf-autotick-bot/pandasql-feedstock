...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pandasql-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13071&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pandasql-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pandasql` can be installed with:

```
conda install pandasql
```

It is possible to list all of the versions of `pandasql` available on your platform with:
